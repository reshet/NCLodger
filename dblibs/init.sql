...
ALTER TABLE ORDERS ADD FOREIGN KEY ( ID_ACC ) REFERENCES ACCOMMODATION ( ID_ACC );
ALTER TABLE ORDERS ADD FOREIGN KEY ( ID_SM ) REFERENCES MANAGER ( ID_SM );
ALTER TABLE ORDERS ADD FOREIGN KEY ( ID_PC ) REFERENCES PROMOCODE ( ID_PC );
...
ALTER TABLE USERS ADD FOREIGN KEY ( ID_UT ) REFERENCES TYPE ( ID_UT );
