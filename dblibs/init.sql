...
CREATE OR REPLACE TRIGGER ACC_SEQ
...
CREATE OR REPLACE TRIGGER CE_SEQ
...
CREATE OR REPLACE TRIGGER H_SEQ
...
CREATE SEQUENCE HM_SEQ START WITH 1
INCREMENT BY 1;
...
CREATE OR REPLACE TRIGGER HM_SEQ
...
CREATE TABLE INITIAL_DISCOUNT
(
  ID_ID INTEGER PRIMARY KEY NOT NULL,
  COMMISSION INTEGER NOT NULL,
  VIP_DISCOUNT INTEGER NOT NULL,
  USER_DISCOUNT INTEGER NOT NULL
);
...
CREATE OR REPLACE TRIGGER SM_SEQ
...
CREATE OR REPLACE TRIGGER ORDER_SEQ
...
CREATE OR REPLACE TRIGGER PROMO_SEQ
...
CREATE OR REPLACE TRIGGER UT_SEQ
...
CREATE OR REPLACE TRIGGER UTC_SEQ
...
ALTER TABLE ACCOMMODATION ADD FOREIGN KEY ( ID_HOTEL ) REFERENCES HOTEL ( ID_HOTEL ) ON DELETE CASCADE;
ALTER TABLE CONFIRM ADD FOREIGN KEY ( ID_USER ) REFERENCES USERS ( ID_USER ) ON DELETE CASCADE;
ALTER TABLE HOTEL_MANAGER ADD FOREIGN KEY ( ID_HOTEL ) REFERENCES HOTEL ( ID_HOTEL ) ON DELETE CASCADE;
ALTER TABLE HOTEL_MANAGER ADD FOREIGN KEY ( ID_SM ) REFERENCES MANAGER ( ID_SM )ON DELETE CASCADE;
ALTER TABLE ORDERS ADD FOREIGN KEY ( ID_ACC ) REFERENCES ACCOMMODATION ( ID_ACC ) ON DELETE CASCADE;
ALTER TABLE ORDERS ADD FOREIGN KEY ( ID_SM ) REFERENCES MANAGER ( ID_SM ) ON DELETE CASCADE;
ALTER TABLE ORDERS ADD FOREIGN KEY ( ID_PC ) REFERENCES PROMOCODE ( ID_PC ) ON DELETE CASCADE;
ALTER TABLE ORDERS ADD FOREIGN KEY ( ID_USER ) REFERENCES USERS ( ID_USER ) ON DELETE CASCADE;
ALTER TABLE PROMOCODE ADD FOREIGN KEY ( ID_SM ) REFERENCES MANAGER ( ID_SM ) ON DELETE CASCADE;
ALTER TABLE USERS ADD FOREIGN KEY ( ID_UT ) REFERENCES TYPE ( ID_UT ) ON DELETE CASCADE;
CREATE UNIQUE INDEX "unique_EMAIL" ON USERS ( EMAIL );
CREATE UNIQUE INDEX "unique_ID_USER" ON MANAGER ( ID_USER );
ALTER TABLE USER_TYPE ADD FOREIGN KEY ( ID_UT ) REFERENCES TYPE ( ID_UT ) ON DELETE CASCADE;
ALTER TABLE USER_TYPE ADD FOREIGN KEY ( ID_USER ) REFERENCES USERS ( ID_USER ) ON DELETE CASCADE;
